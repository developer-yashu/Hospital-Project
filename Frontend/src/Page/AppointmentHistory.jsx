...
//       // USER
//       if (role === "user") {
//         url = "http://127.0.0.1:1010/superadmin/get-user-appointments";
//       }

//       // DOCTOR
//       else if (role === "doctor") {
//         url = "http://127.0.0.1:1010/superadmin/get-doctor-appointments";
//       }
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8 gap-4">
        ...
        <div className="flex gap-4">
          ...
          {role === "user" && (
            <Link
              to="/user-medicines"
              className="px-6 py-3 rounded-xl bg-blue-600 text-white font-semibold shadow-lg hover:bg-blue-700"
            >
              💊 My Medicines
            </Link>
          )}
